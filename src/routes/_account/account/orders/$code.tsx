...
export const Route = createFileRoute("/_account/account/orders/$code")({
  ...
  head: ({ loaderData }) => {
    ...
    const description = `View details for order #${order.code} placed on ${formatDate(order.createdAt)}. Total: ${formatCurrency(order.totalWithTax, order.currencyCode)}. Status: ${order.state}.`;
      ...
      <div className="lg:grid lg:grid-cols-12 lg:gap-x-8">
        ...
        <div className="lg:col-span-4">
          ...
          {order.billingAddress &&
            (() => {
              const billingAddress = readFragment(
                orderAddressFragment,
                order.billingAddress,
              );
              return (
                  ...
                  <div className="border-t border-gray-200 px-4 py-5 sm:px-6">
                    <div className="text-sm text-gray-900">
                      ...
                      {billingAddress.streetLine2 && (
                        <p>{billingAddress.streetLine2}</p>
                      )}
                      <p>
